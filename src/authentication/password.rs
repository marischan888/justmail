...
#[tracing::instrument(name = "Inset the new password into the db", skip(password, pool))]
...
#[tracing::instrument(name = "Get credentials from users.", skip(username, pool))]
...
fn verify_password_hash(
    ...
    let expected_parsed_hash = PasswordHash::new(expected_password_hash.expose_secret())
